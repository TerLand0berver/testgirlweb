...
import { FaHome, FaBriefcase, FaUniversity, FaComments, FaUserCheck } from 'react-icons/fa';
      ...
      <main className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-3xl font-bold">家庭中的“隐形”角落</h2>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
            ...
            <div>
              <div className="flex items-center mb-4">
                <FaBriefcase className="text-purple-500 text-3xl mr-4" />
                <h2 className="text-3xl font-bold">职场上的“玻璃天花板”</h2>
              </div>
              <p className="text-gray-700 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="flex items-center mb-4">
                <FaUniversity className="text-purple-500 text-3xl mr-4" />
                <h2 className="text-3xl font-bold">校园里的“刻板印象”</h2>
              </div>
              <p className="text-gray-700 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
            ...
            <div>
              <div className="flex items-center mb-4">
                <FaComments className="text-purple-500 text-3xl mr-4" />
                <h2 className="text-3xl font-bold">语言中的“无形之墙”</h2>
              </div>
              <p className="text-gray-700 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="flex items-center mb-4">
                <FaUserCheck className="text-purple-500 text-3xl mr-4" />
                <h2 className="text-3xl font-bold">内心的“自我设限”</h2>
              </div>
              <p className="text-gray-700 mb-4">
